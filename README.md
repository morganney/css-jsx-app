...
A small demo app showing how `@knighted/jsx` and `@knighted/css` let a Lit custom element host a React subtree while keeping styles scoped inside the shadow DOM. Bundled with Rspack.
